...
function changeButtons() {
  if (
    maxproductspersite * curpage - 9 <=
      (curpage - 1) * maxproductspersite + sorted &&
    (curpage - 1) * maxproductspersite + sorted < maxproductspersite * curpage
  ) {
...
$(document).ready(function () {
  ...
  $("#next").click(function () {
    if (
      !(
        maxproductspersite * curpage - 9 < total &&
        total < maxproductspersite * curpage
      )
    ) {
      curpage++;
      url = "";
